    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var PremiumColorTransitionHandler = ModuleHandler.extend({
            ...
            run: function () {
                ...
                this.settings.$firstElement = $('#' + elements[0]);
                this.settings.$lastElement = $('#' + elements[elements.length - 1]);
                this.settings.firstElemOffset = this.settings.$firstElement.offset().top;
                this.settings.offset = 'offset' + ('desktop' === currentDevice ? '' : '_' + currentDevice);

                this.lastElemOffset = this.settings.$lastElement.offset().top;
                this.lastElemeHeight = this.settings.$lastElement.outerHeight();
                this.lastElemeBot = this.settings.lastElemOffset + this.settings.lastElemeHeight;
            ...
            getRepeaterSettings: function () {
                ...
                this.settings.downColors = downColors;
                this.settings.itemsIDs = itemsIDs;
                this.settings.upColors = upColors;
            ...
            checkVisible: function () {
                ...
                if ($window.scrollTop() >= settings.lastElemeBot - settings.lastElemeHeight / 4) {
                    ...
                    if (0 !== index)
                        $('#premium-color-transition-' + settins.id).addClass('premium-bg-transition-hidden');
